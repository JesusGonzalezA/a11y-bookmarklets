...
/**
 * Build a CSS selector that uniquely identifies an element in the document.
 */
...
/**
 * Truncate an element's outerHTML to a maximum length.
 */
...
/**
 * Query all elements matching a selector, returning a real Array.
 */
