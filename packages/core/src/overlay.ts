...
/**
 * Remove all previously injected overlays.
 */
...
/**
 * Inject shared base styles (only once).
 */
...
/**
 * Add a label overlay positioned relative to an element.
 */
...
/**
 * Add an outline around an element.
 */
...
/**
 * Show a summary panel in the bottom-right corner.
 */
